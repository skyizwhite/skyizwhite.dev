import { AcademicCapIcon, BadgeCheckIcon, BriefcaseIcon, IdentificationIcon } from '@heroicons/react/outline';
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
      ...
      <ContentBox className="shadow">
        ...
        <ol className="text-sm ml-7 mt-2 sm:mt-4 list-disc">
          ...
          <li>
            <span className="block">2021/04 - 現在</span>
      ...
      <ContentBox className="shadow">
        ...
        <ol className="text-sm ml-7 mt-2 sm:mt-4 list-disc">
          <li>
            <span className="block">2021/05 - 現在</span>
